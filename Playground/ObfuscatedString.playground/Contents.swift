...
/*:
## Overview
- According to the assignement there was a requiremnt to implement a class which takes a string and creates an obfuscated version of it. The **ObfuscatedString** wrapper doesn't make a copy of an original string. It takes a string and crates an obfuscated verison out of it and stores it internaly.
